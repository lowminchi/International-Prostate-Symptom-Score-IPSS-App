...
public class fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mResultDBHelper = new ResultDBHelper(getActivity());
        db = mResultDBHelper.getWritableDatabase();

        lv_result = (ListView) view.findViewById(R.id.lv_history);
    ...
    public void loadData() {
        ...
        while(!cursor.isAfterLast()) {
            if (emailno.equals(cursor.getString(1))) {
                resultInfor.add("\nEmail Address : " + cursor.getString(1)
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_list_item_1, resultInfor);
